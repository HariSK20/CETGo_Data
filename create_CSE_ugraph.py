...
create_nodes_and_edges4 = create_circular_relationship(nodes[40:47])
# print(create_nodes_and_edges4)

create_nodes_and_edges = create_nodes_and_edges + create_nodes_and_edges2 + create_nodes_and_edges3 + create_nodes_and_edges4
...
create_nodes_and_edges = create_nodes_and_edges + create_nodes_and_edges5[:-2] + ';'
